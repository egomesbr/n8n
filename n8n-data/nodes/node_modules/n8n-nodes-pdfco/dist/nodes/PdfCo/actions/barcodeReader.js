...
exports.description = [
    {
        ...
        displayOptions: {
            show: {
                operation: [GenericFunctions_1.ActionConstants.BarcodeReader],
            },
        },
    },
    {
...
async function execute(index) {
    ...
    const types = this.getNodeParameter('types', index);
    ...
    if (fileName)
        body.name = fileName;
    const opticalMarks = advancedOptions === null || advancedOptions === void 0 ? void 0 : advancedOptions.types;
    if (opticalMarks)
        body.types = opticalMarks;
    ...
    const responseData = await GenericFunctions_1.pdfcoApiRequestWithJobCheck.call(this, '/v1/barcode/read/from/url', body);
