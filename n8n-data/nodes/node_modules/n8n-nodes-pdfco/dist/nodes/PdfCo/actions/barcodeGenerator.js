...
exports.description = [
    {
        ...
        displayOptions: {
            show: {
                operation: [GenericFunctions_1.ActionConstants.BarcodeGenerator],
            },
        },
    },
    {
...
async function execute(index) {
    ...
    const decorationImage = this.getNodeParameter('decorationImage', index);
    if (decorationImage)
        body.decorationImage = decorationImage;
    ...
    const responseData = await GenericFunctions_1.pdfcoApiRequest.call(this, '/v1/barcode/generate', body);
