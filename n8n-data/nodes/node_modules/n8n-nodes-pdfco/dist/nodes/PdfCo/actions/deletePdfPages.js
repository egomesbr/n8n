...
exports.description = [
    {
        ...
        displayOptions: {
            show: {
                operation: [GenericFunctions_1.ActionConstants.DeletePdfPages],
            },
        },
    },
    {
...
async function execute(index) {
    ...
    const responseData = await GenericFunctions_1.pdfcoApiRequestWithJobCheck.call(this, '/v1/pdf/edit/delete-pages', body);
    return this.helpers.returnJsonArray(responseData);
}
//# sourceMappingURL=deletePdfPages.js.map