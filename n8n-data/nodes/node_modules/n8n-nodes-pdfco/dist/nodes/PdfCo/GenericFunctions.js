...
async function pdfcoApiRequest(url, body = {}, method = 'POST', qs = {}, option = {}) {
    ...
    let options = {
        baseURL: constants_1.PDFCO_CONSTANTS.BASE_URL,
        url: url,
        headers: {
            'content-type': 'application/json',
            'x-api-key': credentials.apiKey,
            'user-agent': constants_1.PDFCO_CONSTANTS.USER_AGENT,
        },
        method,
        qs,
        body,
...
function sanitizeProfiles(data) {
    ...
    try {
        ...
        throw new Error('Invalid JSON in Profiles. Check https://docs.pdf.co/api-reference/profiles/ or contact support@pdf.co for help. ' +
            error.message);
    }
}
...
ActionConstants.AiInvoiceParser = 'AI Invoice Parser';
ActionConstants.MergePdf = 'Merge PDF';
ActionConstants.SplitPdf = 'Split PDF';
ActionConstants.UrlHtmlToPDF = 'URL/HTML to PDF';
ActionConstants.ConvertToPDF = 'Convert to PDF';
ActionConstants.ConvertFromPDF = 'Convert from PDF';
ActionConstants.AddTextImagesToPDF = 'Add Text/Images to PDF';
ActionConstants.FillPdfForm = 'Fill a PDF Form';
ActionConstants.PDFInfo = 'PDF Information & Form Fields';
ActionConstants.CompressPdf = 'Compress PDF';
ActionConstants.PDFSecurity = 'PDF Security';
ActionConstants.RotatePdf = 'Rotate PDF Pages';
ActionConstants.DeletePdfPages = 'Delete PDF Pages';
ActionConstants.SearchPdf = 'Search in PDF';
ActionConstants.SearchAndReplaceDelete = 'Search & Replace Text or Delete';
ActionConstants.BarcodeReader = 'Barcode Reader';
ActionConstants.BarcodeGenerator = 'Barcode Generator';
ActionConstants.MakePdfSearchable = 'Make PDF Searchable or Unsearchable';
ActionConstants.UploadFile = 'Upload File to PDF.co';
